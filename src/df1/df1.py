...
oServer = TcpMaster(server="96.1.105.126", port=4103, src=0x0, dst=0x1, timeout_in_sec=5.0)
...
#10 02 01 00 0F 00 CB 00 A2 02 01 8C 01 00 10 03 95 19 
#10 02 01 00 0f 00 60 0c a2 01 01 8c 01 05 10 03 1d 18
#16, 2, 0, 1, 79, 16, 16, 96, 12, 16, 3, 21, 192
##aTag = ['N7:0','N7:1','N7:2','N7:3','','']
